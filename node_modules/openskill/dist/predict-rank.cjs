...
// src/predict-rank.ts
var predict_rank_exports = {};
__export(predict_rank_exports, {
  default: () => predict_rank_default
});
module.exports = __toCommonJS(predict_rank_exports);
...
var predictWin = (teams, options = {}) => {
  ...
  const denom = n * (n - 1) / 2;
  const wins = (0, import_ramda2.reduce)(
    (acc, [i, j]) => {
...
//# sourceMappingURL=predict-rank.cjs.map