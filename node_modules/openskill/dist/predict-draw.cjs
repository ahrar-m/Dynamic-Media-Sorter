...
var predictDraw = (teams, options = {}) => {
  ...
  const totalPlayerCount = (0, import_ramda2.reduce)((acc, t) => acc + t.length, 0, teams);
  ...
  const idx = (0, import_ramda2.range)(0, teamRatings.length);
  const pairs = (0, import_ramda2.filter)(([i, j]) => i < j, (0, import_ramda2.xprod)(idx, idx));
  const { total, count } = (0, import_ramda2.reduce)(
    (acc, [i, j]) => {
...
//# sourceMappingURL=predict-draw.cjs.map