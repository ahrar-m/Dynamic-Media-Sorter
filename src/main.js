...
function pickNextMatchup() {
    ...
    let desiredNewFiles = 2; // Golden Ratio mix: 2 new, 2 old
    if (activeValid.length < 2) desiredNewFiles = 4 - activeValid.length;
    else if (activeValid.length < 4) desiredNewFiles = 4 - activeValid.length;
